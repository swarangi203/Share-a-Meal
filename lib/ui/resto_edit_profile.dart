...
class EditProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: EditRestoProfile(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class EditRestoProfile extends StatefulWidget {
  @override
  _EditRestoProfileState createState() => _EditRestoProfileState();
}

class _EditRestoProfileState extends State<EditRestoProfile> {
  String temp;
